...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        degreeText = (TextView) findViewById(R.id.degreee_text);
        ...
        navButtion = (Button) findViewById(R.id.nav_button);
        navButtion.setOnClickListener(new View.OnClickListener(){
            @Override
